...
export function ChatPanel({ dataSource, predictionType, resumeConversationId, resumeTurns, resumeAssessment }: ChatPanelProps) {
  ...
  async function sendMessage() {
    ...
    try {
      ...
      const message = error instanceof Error ? error.message : "Unable to complete the assessment.";
            ...
            <div key={msg.id} className="result-card">
              ...
              <div className="result-card__body">
                <div className="result-card__meta">
                  ...
                  {msg.result.scoreType === "probability" ? "Probability" : "Normalized rule score"}
                </div>
